            ...
            while ($row = $result->fetch_assoc()) {
                echo "
                    ...
                    "</td>
                        <td>{$row["part_name"]}</td>
                        <td class='action'>
                            <a class='btn-edit bg-default' href='workstation-edit.php?workstation_id=$row[workstation_id]'>
                            ...
                            <a class='btn-delete bg-red' href='workstation-delete.php?workstation_id=$row[workstation_id]'>
